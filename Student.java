...
public class Student {
    ...
    public static class Course {
        ...
        public int getSemester() {
            LocalDate startDate = LocalDate.of(date.getYear(), 3, 1);
 ...
 class Main {
    public static void main(String[] args) {
        ...
        Student student1 = new Student("Aniqa");
        student.addCourse(new Student.Course(LocalDate.of(2022, 6, 1), "Mathematics", 85));
        
        student1.addCourse(new Student.Course(LocalDate.of(2022, 5, 1), "Physics", 90));
